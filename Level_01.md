...
## Takeaway
This level taught me how to interact with different file names because - is interpreted as stdin in many Unix commands, I need to
find workarounds. Although my method worked, I could have prefixed the file name with ./
```bash
cat ./-
```
